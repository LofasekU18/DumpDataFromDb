    ...
    static void Main()
    {
        ...
        try
        {
            using (StreamWriter writer = new StreamWriter(filePath, true))
            {
                ...
                Console.WriteLine("Data has been written to the file, skipping lines that are already present.");
            }
        }
        catch (Exception ex)
        {

            Console.WriteLine("Soubor problem" + ex.Message);
        }
